...
@section('content')
    <div class="relative min-h-screen flex flex-col items-center justify-center bg-cover bg-center bg-no-repeat"
        ...
        <div class="relative text-center text-gray-100 px-6 max-w-3xl">
            <h1 class="text-6xl font-extrabold tracking-tight leading-tight mb-6 drop-shadow-lg">
                Encuentra tu hogar ideal con <span class="text-blue-400">LaraRent</span>
            </h1>
            <p class="text-2xl text-gray-200 mb-8 drop-shadow-md">
